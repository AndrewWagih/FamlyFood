    ...
    <div class="container">
        ...
        @endif
          ...
          <form method="POST" action="{{route('login.request')}}">
            ...
            <input type="email" id="email" name="email" placeholder="ادخل الايميل">
            <div style="
            position: relative;
            display: block;
            width: 93%;
        ">
                <label for="password" style="display: block;width:100%">كلمة المرور</label>
                <input type="password" id="password" class="password" name="password" placeholder="ادخل كلمة المرور" style="display: block;width:100%">
            ...
            <button type="submit">تسجيل الدخزل</button>
          </form>
        </div>
